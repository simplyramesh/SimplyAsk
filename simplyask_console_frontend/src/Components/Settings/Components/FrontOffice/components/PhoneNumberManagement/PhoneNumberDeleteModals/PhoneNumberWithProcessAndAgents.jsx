...
const PhoneNumberProcessAndAgentsModal = ({
  isOpen,
  onCloseModal,
  onSuccessClick,
      ...
      <StyledFlex gap="20px 0" m="0px 5px">
        <StyledText display="inline" p="10px 20px" size={16} lh={16} weight={600} textAlign="center">
          <StyledText as="span" display="inline" size={14} lh={19}>
            You are about to delete <StyledText as="span" display="inline" size={14} weight={600}>{phoneNumberFromRow}</StyledText>.
            To complete this, you must move the currently associated Processes and Agent to a different number.
        ...
        />
        <StyledText display="inline" size={14} weight={600} mt={-5} textAlign="center">
          Or
        </StyledText>
        <StyledText
          cursor="pointer"
...
export default PhoneNumberProcessAndAgentsModal;
