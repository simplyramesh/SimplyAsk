...
import { ProductOffersCardPricePerUnit, ProductOffersCardTextBody } from '../../../ProductOfferings/ProductOffersCard/ProductOffersCardText';
import { StyledListItem } from '../../../ProductOfferings/StyledProductOffers';

const GoAOfferDetailsModal = ({ open, closeFunction, product }) => {
...
export default GoAOfferDetailsModal;
