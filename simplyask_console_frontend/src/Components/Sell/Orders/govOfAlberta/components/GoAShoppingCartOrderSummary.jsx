...
import { getGoATotalSummary } from '../../../utils/helpers';
import ProductOfferingsCheckoutProductReview from '../../ProductOfferings/ProductOfferingsCheckout/ProductOfferingsCheckoutProductReview/ProductOfferingsCheckoutProductReview';
import OrderSummaryDetailItem from '../../ProductOfferings/ShoppingCart/ShoppingCartOrderSummary/OrderSummaryDetailItem';
import {
  StyledCheckoutButton, StyledOrderSummary, StyledPromoCodeInput, StyledSavingsApplied,
} from '../../ProductOfferings/ShoppingCart/StyledShoppingCart';

const GoAShoppingCartOrderSummary = ({
  orderItems = [], hideProceedToCheckout, width, hidePromoCodeInput, showItems = false,
}) => {
  ...
  const totalSummary = getGoATotalSummary(orderItems);
        ...
        <StyledFlex direction="row" justifyContent="space-between" width="100%">
          <StyledFlex width={263} alignItems="start">
            <StyledText weight={700}>
              {`${!hideProceedToCheckout || !hidePromoCodeInput ? 'Estimated ' : ''}Total:`}
            </StyledText>
          </StyledFlex>
...
export default GoAShoppingCartOrderSummary;
