...
import { CONVERSE_DASHBOARD_FILTER_TYPE_KEYS } from '../../../utils/constants';
...
const ChartFiltersSideFilters = ({
  ...
  return (
    <StyledFlex flex="1 1 auto" p="0 24px 24px 24px">
      ...
      <StyledFlex>
        {showFiltersType?.sideFilters?.[CONVERSE_DASHBOARD_FILTER_TYPE_KEYS.SIDE_FILTERS.AGENTS]
        && (
          <CustomSelect
            name={CONVERSE_DASHBOARD_FILTER_TYPE_KEYS.SIDE_FILTERS.AGENTS}
            options={allAgentsOptions}
            value={values[CONVERSE_DASHBOARD_FILTER_TYPE_KEYS.SIDE_FILTERS.AGENTS]}
        ...
        {showFiltersType?.sideFilters?.[CONVERSE_DASHBOARD_FILTER_TYPE_KEYS.SIDE_FILTERS.AGENT_TAGS]
        && (
          <CustomSelect
            name={CONVERSE_DASHBOARD_FILTER_TYPE_KEYS.SIDE_FILTERS.AGENT_TAGS}
            options={allAgentTagsOptions}
            value={values[CONVERSE_DASHBOARD_FILTER_TYPE_KEYS.SIDE_FILTERS.AGENT_TAGS]}
            onChange={handleDropdownFilterChange}
...
export default ChartFiltersSideFilters;
