...
import classes from './EventsSubscription.module.css';
...
const EventsSubscription = () => {
  ...
  const tableRowClick = (rowId) => {
    navigate(`${routes.CATALOG_EVENTS_SUBSCRIPTION}/${rowId}`);
  };
      ...
      <Card className={classes.filters}>
        ...
        <div>
          <Button
            ...
            borderRadius="0"
            onClick={() => navigate(`${routes.CATALOG_EVENTS_SUBSCRIPTION_DETAILS}`, { state: { addNew: true } })}
          >
            <span>+</span>
            Add New
          </Button>
