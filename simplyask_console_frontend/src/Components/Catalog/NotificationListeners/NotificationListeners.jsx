...
import classes from './NotificationListeners.module.css';
...
const NotificationListeners = () => {
  ...
  const tableRowClick = (rowId) => {
    navigate(`${routes.CATALOG_NOTIFICATION_LISTENER}/${rowId}`);
  };
    ...
    <>
      <TopMenuBar>
        <div className={classes.topBarLeft}>
          ...
          <span>Notification Listeners</span>
        </div>
      </TopMenuBar>
      <Card className={classes.filters}>
        ...
        <div>
          <Button
            ...
            borderRadius="0"
            onClick={() => navigate(`${routes.CATALOG_NOTIFICATION_LISTENER_DETAILS}`, { state: { addNew: true } })}
          >
            <span>+</span>
            Add New
          </Button>
